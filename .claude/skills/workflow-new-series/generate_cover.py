#!/usr/bin/env python3
"""
Generate series cover image using Replicate Seedream-4.5 API.

Usage:
    python generate_cover.py <output_path> <prompt>

Arguments:
    output_path  Path to save cover image (e.g., "cover.jpg")
    prompt       The image generation prompt

Example:
    python generate_cover.py cover.jpg "Portrait of a cultivator..."

The script uses 3:4 aspect ratio for book cover format.
"""
...
def generate_cover(output_path, prompt):
    """Generate a cover image with the given prompt."""
    ...
    print(f"Starting cover generation...")
...
if __name__ == "__main__":
    ...
    success = generate_cover(output_path, prompt)
